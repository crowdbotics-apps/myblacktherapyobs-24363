...
let DATA = [
  ...
  },
  {
    name: "John Alexer",
    passion: "Member",
    url: require("../../Assets/profile8.png"),
...
let Groups = [
  ...
  },
  {
    name: "John Alexw",
    passion: "Therapist",
    url: require("../../Assets/profile7.png"),
    Description: [
      "This is my description of therapy, i am a profesiional and looking for therapy job",
    ],
  },
...
let Shirts = [
  ...
  },
  {
    ...
    url: require("../../Assets/whiteshirt.png"),
  },
  {
    name: "Brand Tshirts",
...
let Event = [
  {
    name: "Weekly Hangout",
    subname: "Adult services of child abuse",
...
const Community = (props) => {
  ...
  const renderItem1 = ({ item }) => (
    ...
    >
      <Image style={styles.therapistImage} source={item.url} />
    </View>
  );
    ...
    >
      ...
      >
        <View style={{ justifyContent: "center" }}>
          ...
          <Text style={{ color: "white", fontSize: 10 }}>{item.subname}</Text>
  ...
  const renderItem2 = ({ item }) => (
    ...
    >
      ...
      >
        <Image style={styles.shiertImage} source={item.url} />
  ...
  const renderItem = ({ item }) => (
    <View style={{ padding: 10, backgroundColor: "white", margin: 5 }}>
      ...
      >
        <Image style={styles.postprofileimage} source={item.url} />

        <View>
          <Text style={styles.textFormat1}>{item.name}</Text>
          <Text style={{ color: colors.grey }}>{item.passion}</Text>
        </View>
      </View>
      <Text
        style={{
